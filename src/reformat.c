...
#include <stdio.h>  /*chengzhi included stdio.h*/
...
/* must point to the last word. Returns <newL>. Uses errmsg. */
{
  ...
  const char * const impossibility1 =
    "Impossibility #1 has occurred. Please report it.\n";
  const char * const impossibility2 =
    "Impossibility #2 has occurred. Please report it.\n";
  const char * const impossibility3 =
    "Impossibility #3 has occurred. Please report it.\n";
